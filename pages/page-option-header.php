...
<div class="wrap">
	...
	<h2 class="row col-xs-12 v-middel">
		...
		</a> <a href="<?php echo Plugin_Core::$current_plugin_data['HelpSup']; ?>" target="_blank"  class="supporticon content animated rotate-animation">Support Desk A</a>
		 <a href="<?php echo Plugin_Core::$current_plugin_data['UserDoc']; ?>" target="_blank"  class="guideicon content animated rotate-animation">How To Guide</a>		 
	</h2>
	<div class="wrapper">
		<div class="postbox plugin-wrap <?php echo getPluginShortName(); ?> <?php echo page_css_class(); ?>">
		<header class="panel-heading page-title"><h2><?php echo page_title(); ?><div id="load_bar_ctrl" class="pull-right"><img alt="Loading..." src="<?php echo WPQP_PLUGIN_IMGDIR_URL;?>/loading_bar.gif"></div></h2></header>